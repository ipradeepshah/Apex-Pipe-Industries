...
export const metadata: Metadata = {
  ...
  description:
    " Apex Pipe Industries is one of the leading manufacturer of PVC Pipes in Nepal, having a track record of successfully manufacturing & marketing uPVC pipes conforming to different standards ranging from 1½ to 8",
  keywords: [
